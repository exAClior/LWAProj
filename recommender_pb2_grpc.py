...
class RecommenderStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Recommend = channel.unary_unary(
        ...
        request_serializer=recommender__pb2.WhichUser.SerializeToString,
        response_deserializer=recommender__pb2.UserList.FromString,
        )
...
def add_RecommenderServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Recommend': grpc.unary_unary_rpc_method_handler(
          servicer.Recommend,
          request_deserializer=recommender__pb2.WhichUser.FromString,
          response_serializer=recommender__pb2.UserList.SerializeToString,
      ),
  }
